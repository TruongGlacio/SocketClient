...
public class ClientSocket {
    ...
    public class ServerListenner extends AsyncTask<Void, String, String> {
        public void ReadData(String messenge){
            try {
    ...
    public interface ServerListener{
        ...
        String ReadData(String messenge);
    }
}
